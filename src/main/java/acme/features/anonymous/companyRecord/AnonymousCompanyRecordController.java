...
public class AnonymousCompanyRecordController extends AbstractController<Anonymous, CompanyRecord> {
	...
	@Autowired
	private AnonymousCompanyRecordListMainService	listMainTopService;
	...
	private void initialise() {
		...
		super.addCustomCommand(CustomCommand.LIST_MAIN, BasicCommand.LIST, this.listMainTopService);
	}
